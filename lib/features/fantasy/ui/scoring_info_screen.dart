      ...
      body: ListView(
        ...
        children: [
          ...
          _Section('Einsatz', const [
            ...
            _Row('30–59 Min', '+4'),
            _Row('60–89 Min', '+6'),
            _Row('90 Min (komplett)', '+10'),
          ]),
          _Section('Offensive (alle Positionen)', const [
            _Row('Tor', '+16'),
            _Row('Tor per Elfmeter', '+12'),
            _Row('Vorlage', '+12'),
            _Row('Großchance kreiert', '+6'),
            _Row('Key Pass', '+1,5'),
            _Row('Schuss aufs Tor', '+2'),
            _Row('Erfolgreiches Dribbling', '+1'),
          ]),
          _Section('Defensive', const [
            ...
            _Row('Balleroberung', '+1'),
            _Row('Klärung', '+0,4'),
            _Row('Geblockter Schuss', '+1'),
          ]),
          _Section('Meilenstein-Boni (kumulativ, pro Spiel)', const [
            _Row('Paraden (TW): ≥5', '+8'),
            _Row('Paraden (TW): ≥8', '+12 zusätzlich (ges. +20)'),
            _Row('Def-Aktionen TW/ABW: ≥9 / ≥14 / ≥19', 'je +6 (max +18)'),
            _Row('Def-Aktionen MIT: ≥10 / ≥14', 'je +6 (max +12)'),
            _Row('Def-Aktionen ANG: ≥8 / ≥12', 'je +6 (max +12)'),
          ], footnote: 'Def-Aktionen = Tacklings + Balleroberungen + Klärungen + Blocks'),
          _Section('Negativ (alle Positionen)', const [
            _Row('Gelbe Karte', '−4'),
            _Row('Gelb-Rot (zusätzlich)', '−6'),
            _Row('Rote Karte (direkt)', '−10'),
            _Row('Eigentor', '−12'),
            _Row('Verschossener Elfmeter', '−8'),
            _Row('Fehler vor Gegentor', '−6'),
            _Row('Großchance vergeben', '−4'),
            _Row('Abseits', '−1'),
            _Row('Foul', '−0,4'),
            _Row('Ballverlust', '−0,4'),
          ]),
