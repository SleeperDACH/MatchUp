...
final offeneTippsProvider =
    FutureProvider.family<OffeneTipps, String>((ref, roundId) async {
  ...
  try {
    ...
    final week =
        weeks.firstWhere((w) => w.index == index, orElse: () => weeks.last);
    ...
    return OffeneTipps(
        anzahl: fehlend.length, frist: fehlend.first.kickoff.toLocal());
  } catch (_) {
